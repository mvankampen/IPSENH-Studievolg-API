...
ALTER TABLE ab_restriction OWNER TO postgres;
...
ALTER TABLE course_enrollment OWNER TO postgres;
...
ALTER TABLE course_owner OWNER TO postgres;
...
ALTER TABLE course_passed OWNER TO postgres;
...
ALTER TABLE course_restriction OWNER TO postgres;
...
CREATE INDEX fki_course ON ab_restriction USING btree (course);
...
CREATE INDEX fki_course_name ON course_restriction USING btree (course);
...
CREATE INDEX fki_required_course ON ab_restriction USING btree (required_course);
...
CREATE INDEX fki_restriction ON course_restriction USING btree (restriction);
