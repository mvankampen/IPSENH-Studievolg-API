...
public class ABRestrictionTest {
  ...
  public static final ResourceTestRule resources = ResourceTestRule.builder()
      .addResource(new ABRestrictionResource(new ABRequirementService(dao, service)))
      .build();
  ...
  @Test
  public void insertABRestriction() {
    Response response = resources.target("/ab-restrictions").request().post(Entity.json(abRequirement));
