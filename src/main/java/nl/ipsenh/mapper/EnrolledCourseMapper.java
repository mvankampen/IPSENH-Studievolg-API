...
public class EnrolledCourseMapper implements ResultSetMapper<EnrolledCourse> {
  ...
  @Override
  public EnrolledCourse map(int i, ResultSet resultSet, StatementContext statementContext) throws SQLException {
    return new EnrolledCourse(resultSet.getString("course_code"), resultSet.getString("user_email"));
  }
}
